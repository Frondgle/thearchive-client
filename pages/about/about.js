...
const LINKS = [
  { href: 'https://www.instagram.com/thesonatorearchive', label: 'Instagram', src: '/images/instagramIcon.webp', alt: 'Instagram' },
  { href: 'https://www.youtube.com/@sonatore1525',        label: 'YouTube',   src: '/images/youTubeIcon.webp',   alt: 'YouTube' },
  { href: 'https://open.spotify.com/artist/4riQpqytzfECeWtiZ9ksYV?si=qqeh7sj-RrK9GLXHYUeUaw', label: 'Spotify',  src: '/images/spotifyIcon2.png', alt: 'Spotify' },
  { href: 'https://sonatore.bandcamp.com',                 label: 'Bandcamp',  src: '/images/bandcampIcon.png',  alt: 'Bandcamp' },
  { href: 'https://discord.com/invite/ScsaJSPTdj',         label: 'Discord',   src: '/images/discordIcon.jpg',   alt: 'Discord' },
];
